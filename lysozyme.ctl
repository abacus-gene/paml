    ...
    fix_omega = 0   * 1: omega or omega_1 fixed, 0: estimate 
        omega = 10   * initial or fixed omega, for codons or codon-transltd AAs
...
*       When running the program, input the branch labels as:  
...
* branch).  You can prepare the labels in a file and copy and paste them 
